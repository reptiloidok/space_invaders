...
# изображения
bg_img = pg.image.load('No_thanks/src/background.png')
icon_img = pg.image.load('No_thanks/src/ufo.png')
...
font = pg.font.Font('No_thanks/src/04B_19.TTF', 48)
...
# игрок
player_img = pg.image.load('No_thanks/src/player.png')
...
# пуля
bullet_img = pg.image.load('No_thanks/src/bullet.png')
...
# противник
enemy_img = pg.image.load('No_thanks/src/enemy.png')
